...
\subsection{GBLUP and Bayesian methods}
...
accession subsets, again, randomly 5 times. Both trials were run with 50 fold validation
...
\subsubsection{Number of accessions and prediction accuracy}
...
\begin{figure}[H]
 ...
 \caption[Predictive ability as a function of the number of markers]{Predictive ability as
   ...
   with 50 fold validation each. The pointsize indicates the standard error}
...
Proposal of using GS and GP to select ideal training populations from a larger pool.