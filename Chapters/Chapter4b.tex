...
To account for GxE best linear unbiased estimators (BLUE) were calculated according to
...
genomes for 1035 ecotypes along 600k marker data for 1307 accessions with an overlap
between those groups resulting in a total of 2029 genotyped accessions, totaling in more
than 10 mio. SNPs and Indels on the five chromosomes of \textit{A. thaliana}. Imputation of
missing data and upsampling of the 600k subsets was performed with Beagle3
...
the full data sets randomly 20\% were assigned to TST and 80\% to TRN. This process was
...
\begin{figure}[H]
  \centering
  \includegraphics[height=.55\textheight, width=0.99\textwidth]{ann_vs_gblup}
  \decoRule
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.49\textheight, width=0.99\textwidth]{gp_kemater}
 \decoRule
...
While prediction for the Kemater subset shows that ANNs can perform reasonably well
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.495\textheight, width=0.99\textwidth]{gp_petkuser}
 \decoRule
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.895\textheight, width=0.99\textwidth]{SL_pred}
 \decoRule
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.55\textheight, width=0.99\textwidth]{pred_acc_bayes}
 \decoRule
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.55\textheight, width=0.99\textwidth]{marker_vs_acc}
 \decoRule
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.55\textheight, width=0.99\textwidth]{phenos_acc}
 \decoRule
 \caption[Predictive ability as a function of the number of markers]{Predictive ability as
...
\begin{figure}[H]
 \centering \includegraphics[angle=0,height=.55\textheight, width=0.99\textwidth]{herit_acc}
 \decoRule
...
including multiple traits and environments to increase prediction accuracies.
