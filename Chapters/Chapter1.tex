...
To assess the performance on assemblies without a published chloroplast on \texttt{CpBase} \cite{cpbase} 105 data sets were selected from SRA, it was emphasized that such data sets were selected, with the next relatives with a reference chloroplast as distantly related as possible in taxonomic terms according to NCBI \cite{ncbitaxonomy}
