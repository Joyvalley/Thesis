...
A common problem in machine learning is to over parameterize the model on the training
...
\begin{table}[H]
\caption[Overview over selected Bayesian methods]{Overview of properties of a variety of commonly applied Bayesian methods for genomic prediction. Table altered after \cite{karkkainen2012back}}
\label{tab:bayesABC}
\centering
