...
The $M$ matrix is all the information that is necessary for the computation of the K matrix and other viable genetic paramters. The $MM'$ matrix (\ref{MM'}) additional parameters.
