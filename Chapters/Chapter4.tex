...
\begin{figure}[H]
  \centering \includegraphics[angle=90,height=.95\textheight, width=1.0\textwidth]{gp_kemater}
  \decoRule
...
\begin{figure}[H]
  \centering \includegraphics[angle=90,height=.95\textheight, width=1.0\textwidth]{gp_petkuser}
  \decoRule
