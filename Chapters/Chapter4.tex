...
\cite{browning2018one}. After LD pruning and further quality control 29833 markers remained and 471 Kemater DHs
...
data for 1307 accessions with a overlap between those groups resulting in a total of 2029 genotyped
...
every one of the 164 phenotypes used subsets were sampled and LD pruned and MAF filtered.  LD pruning was
executed with the R-package SNPRelate \cite{zheng2013tutorial} with a relatively strict LD threshold of $0.65$
and $MAF > 10 $. This resulted in data sets with approximately 150.000 markers for each phenotype.
