...
A common problem in machine learning is over parameterize the model on the training data
...
proven, there is no evidence that neural networks can generally outperform
