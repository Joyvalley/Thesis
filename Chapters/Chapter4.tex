...
\begin{figure}[H]
  \centering \includegraphics[height=.35\textheight, width=1.0t\textwidth]{Figures/overfitting} \decoRule
...
$\rho(y,\hat{y}) < .30$ GBLUP appears to be better than the tested ANNs.\\
...
across environment BLUEs (previous section)-
