...
% Template license:
% CC B-NC-SA 3.0 (http://creativecommons.org/licenses/by-nc-sa/3.0/)
...
oneside, % Two side (alterating margins) for binding by default, uncomment to switch to one side
...
]{MastersDoctoralThesis} % The class file specifyingthe document structure
...
%	THESIS INFORMATION
%----------------------------------------------------------------------------------------
\thesistitle{Quantitative genetics - from genome assemlbies to neural network aided omics based prediction of quantitative traits} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\keywords{} % Keywords for your thesis, this is not currently used anywhre in the template, print it elsewhere with \keywordnames
...
% \addlinespace % Gap to separate the Roman symbols frm the Greek
