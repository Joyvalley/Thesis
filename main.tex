...
%%author year style
\usepackage[backend=bibtex,style=authoryear,natbib=true]{biblatex} % Use the bibtexy
...
\begin{abbreviations}{ll} % Include a list of abbreviations (a table of two columns)
 ...
 \textbf{Adam} \textbf{Ada}aptive \textbf{M}oment estimation \\
...
% \begin{symbols}{lll} % Include aist of Symbols (a three column table)
%   $a$ & distce & \si{\meter} \\
